...
| WA-021 | P2 | Security | Definir clasificación y retención de datos | Tabla de categorías, retención, cifrado y borrado | Requisitos legales | Completado para el alcance sintético de laboratorio: política versionada con allowlist de atributos, clasificación, rechazo de PII/secretos, retención, borrado y responsabilidad humana. Datos reales, región, modelo, IAM Bedrock e inferencia continúan prohibidos y sujetos a decisiones posteriores. |

...
| WA-014 | P1 | Operational excellence | Enrutar alarmas a un canal real | Una alarma de prueba llega a un receptor autorizado | SNS y Amazon Q Developer para Slack | Completado: entrega real ALARM/OK en Slack, evidencia saneada y eliminación del stack verificadas |
...
| WA-021 | P2 | Security | Definir clasificación y retención de datos | Tabla de categorías, retención, cifrado y borrado | Requisitos legales | Completado para el alcance sintético de laboratorio. Datos reales, región, modelo, IAM Bedrock e inferencia continúan prohibidos. Existe una selección reversible y desactivada de región/modelo con guardrail; acceso, términos e inferencia real continúan sin autorizar. |
...
| WA-032 | P1 | Security | Preparar preflight de acceso Bedrock de solo lectura | Workflow manual protegido, OIDC, consultas de control plane y evidencia sanitizada | WA-031 | Implementado pero desactivado; Environment y rol no configurados, workflow no ejecutado, acceso no comprobado e inferencia no autorizada |
